...
#SBATCH --gres=gpu:1
#SBATCH --array 1-3
#SBATCH -o /n/home12/binxuwang/Github/DiT/cluster_logs/DiT_stream_repeat_RAVEN_%A_%a.out  # File to which STDOUT will be written, %j inserts jobid
#SBATCH -e /n/home12/binxuwang/Github/DiT/cluster_logs/DiT_stream_repeat_RAVEN_%A_%a.err  # File to which STDERR will be written, %j inserts jobid
#SBATCH --mail-user=binxu_wang@hms.harvard.edu

echo "$SLURM_ARRAY_TASK_ID"
param_list=\
'--expname stream0_16M_heldout0_rep --model DiT_S_1 --dataset RAVEN10_abstract  --cmb_per_class   4000  --num-classes 0  --class_dropout_prob 1.0  --heldout_ids 1  16  20  34  37 
--expname stream0_16M_heldout0_rep --model DiT_S_1 --dataset RAVEN10_abstract  --cmb_per_class   4000  --num-classes 0  --class_dropout_prob 1.0  --heldout_ids 1  16  20  34  37 
--expname stream0_16M_heldout0_rep --model DiT_S_1 --dataset RAVEN10_abstract  --cmb_per_class   4000  --num-classes 0  --class_dropout_prob 1.0  --heldout_ids 1  16  20  34  37 
--expname stream0_16M_heldout0_rep --model DiT_B_1 --dataset RAVEN10_abstract  --cmb_per_class   4000  --num-classes 0  --class_dropout_prob 1.0  --heldout_ids 1  16  20  34  37 
--expname stream0_16M_heldout0_rep --model DiT_B_1 --dataset RAVEN10_abstract  --cmb_per_class   4000  --num-classes 0  --class_dropout_prob 1.0  --heldout_ids 1  16  20  34  37 
--expname stream0_16M_heldout0_rep --model DiT_B_1 --dataset RAVEN10_abstract  --cmb_per_class   4000  --num-classes 0  --class_dropout_prob 1.0  --heldout_ids 1  16  20  34  37 
'
